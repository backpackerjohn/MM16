export type FinishedWithin = 'P50' | 'P90' | 'AFTER';
...
export type GamEvent =
  ...
  | { type: 'quest_completed'; questId: string; parentGoalId?: string; finishedWithin: FinishedWithin }
  ...
  | { type: 'timer_milestone'; timerId: string; atSeconds: number }
...
export type DayRollup = { day: string; total: number };